...
*/
    ...
    `emp`.`emp_name` AS `emp_name`,  -- Added employee name
...
LEFT JOIN `emp` ON `emp`.`Att_ID` = `actions`.`emp_cd`  -- Joined emp table
ORDER BY `emp`.`emp_name`, `actions`.`issue_date`;  -- Changed order by";
